...
def random_crop(img, size, scale=None, ratio=None):
    ...
    # print('w: ', w, ' h: ', h, ' i: ', i, ' j: ', j, ' image size:', img.shape[0], img.shape[1])
...
def process_image(sample,
    ...
    mean = [0.473, 0.4997, 0.49139] if mean is None else mean
    std = [0.26557, 0.2672, 0.278] if std is None else std
