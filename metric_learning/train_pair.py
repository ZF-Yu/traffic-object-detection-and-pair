...
# yapf: disable
add_arg('model', str, "ResNet152", "Set the network to use.")
...
add_arg('lr_steps', str, "3250, 4250", "step of lr")
add_arg('total_iter_num', int, 4500, "total_iter_num")
add_arg('display_iter_step', int, 10, "display_iter_step.")
add_arg('save_iter_step', int, 250, "save_iter_step.")
add_arg('use_gpu', bool, True, "Whether to use GPU or not.")
add_arg('pretrained_model', str, None, "Whether to use pretrained model.")
add_arg('checkpoint', str, 'output_pair/ResNet152/3500.pdparams', "Whether to resume checkpoint.")
...
add_arg('margin', float, 0.3, "margin.")
